            ...
            <Sheet>
                ...
                <SheetContent side="left">
                    ...
                    <div className="grid gap-2 py-6">
                        <Link href="/tournaments" className="flex w-full items-center py-2 text-lg font-semibold" prefetch={false}>
                            Activities
                        </Link>
                        <Link href="/games" className="flex w-full items-center py-2 text-lg font-semibold" prefetch={false}>
                            Games
                        </Link>
